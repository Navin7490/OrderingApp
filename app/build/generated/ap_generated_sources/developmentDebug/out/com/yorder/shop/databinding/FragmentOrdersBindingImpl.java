...
public class FragmentOrdersBindingImpl extends FragmentOrdersBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.recyclerViewOrderParent, 1);
        sViewsWithIds.put(R.id.progressbar, 2);
        sViewsWithIds.put(R.id.imCartEmpty, 3);
        sViewsWithIds.put(R.id.tvOrderIsEmpty, 4);
        sViewsWithIds.put(R.id.btnCartContinueShopping, 5);
    }
    // views
    @NonNull
