...
public class FragmentSigninBindingImpl extends FragmentSigninBinding  {
    ...
    static {
        ...
        sViewsWithIds.put(R.id.emailTIL, 6);
        sViewsWithIds.put(R.id.passwordTIL, 7);
        sViewsWithIds.put(R.id.forgotPasswordTV, 8);
        sViewsWithIds.put(R.id.or, 9);
        sViewsWithIds.put(R.id.loginWithOtpGo, 10);
        sViewsWithIds.put(R.id.tvAppVersion, 11);
        sViewsWithIds.put(R.id.progressBar, 12);
        sViewsWithIds.put(R.id.signInFAB, 13);
    }
    // views
    @NonNull
